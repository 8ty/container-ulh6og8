...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ulh6og8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ulh6og8.containers.anotherwebservice.com/
...
```
git clone git@github.com:8ty/container-ulh6og8.git
cd container-ulh6og8
```
...
```
docker attach container-ulh6og8
```
